...
public class MockDataSeg implements INamed, IBlockData, IPersistentId, ISegment<Object> {
	...
	public Object f_object = s_object;

	public MockDataSeg() {
	}

	public MockDataSeg(int i, int j) {
		someId = i;
		someData = j;
	}
	...
	public String modifyBody(IBlockData newData) {
		if (newData instanceof MockDataSeg) {
			MockDataSeg md = (MockDataSeg) newData;
			if (someId != md.someId) {
	...
	public boolean equals(Object p_arg0) {
		boolean rVal = false;
		if (p_arg0 instanceof MockDataSeg) {
			MockDataSeg l_arg = (MockDataSeg) p_arg0;
	...
	public void copy(IBlockData p_newData) {
		if (p_newData instanceof MockDataSeg) {
			MockDataSeg l_new = (MockDataSeg) p_newData;
			someId = l_new.someId;
